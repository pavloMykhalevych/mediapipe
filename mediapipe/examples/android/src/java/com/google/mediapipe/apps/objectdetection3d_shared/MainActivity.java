...
public class MainActivity extends com.google.mediapipe.apps.basic.MainActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    inputSidePackets.put("min_tracking_threshold", packetCreator.createFloat64(0.99));
    inputSidePackets.put("min_detecting_threshold", packetCreator.createFloat64(0.5));
    inputSidePackets.put("input_focal_x", packetCreator.createFloat64(3.289440));
    inputSidePackets.put("input_focal_y", packetCreator.createFloat64(1.853493));
    inputSidePackets.put("input_principal_point_x", packetCreator.createFloat64(0.002126));
    inputSidePackets.put("input_principal_point_y", packetCreator.createFloat64(0.034152));
    inputSidePackets.put("oid_model_path", packetCreator.createString("mediapipe/modules/objectron/object_detection_3d.tflite"));
    inputSidePackets.put("box_landmark_model_path", packetCreator.createString("mediapipe/modules/objectron/object_detection_ssd_mobilenetv2_oidv4_fp16.tflite"));
